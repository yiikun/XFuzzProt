...
VL_ATTR_COLD void VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC__0(VVerifyTop_SinkC_2* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC__0\n"); );
...
VL_ATTR_COLD void VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC__1(VVerifyTop_SinkC_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC__0(VVerifyTop_SinkC_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __PVT__beat;
    __PVT__beat = 0;
...
VL_ATTR_COLD void VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC__1(VVerifyTop_SinkC_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_SinkC_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__taskArb__DOT___ctrl_validMask_grantMask_lastGrant_T 
