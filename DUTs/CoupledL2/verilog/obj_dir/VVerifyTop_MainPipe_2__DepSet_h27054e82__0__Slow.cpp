...
VL_ATTR_COLD void VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__0(VVerifyTop_MainPipe_2* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__0\n"); );
    ...
    if (vlSelfRef.io_status_vec_toC_2_valid) {
        ...
        vlSelfRef.io_toSourceC_bits_task_dirty = vlSelfRef.__PVT__task_s5_bits_dirty;
        ...
        vlSelfRef.io_toSourceC_bits_task_dirty = vlSelfRef.__PVT__task_s4_bits_dirty;
        ...
        vlSelfRef.io_toSourceC_bits_task_dirty = vlSelfRef.__PVT__task_s3_bits_dirty;
        vlSelfRef.io_toSourceC_bits_data_data = vlSelfRef.__PVT__c_arb_io_in_2_bits_data_data;
...
VL_ATTR_COLD void VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__1(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__0(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*2:0*/ __PVT__customL1Hint_io_s3_task_bits_opcode;
    __PVT__customL1Hint_io_s3_task_bits_opcode = 0;
...
VL_ATTR_COLD void VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__1(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
