...
VL_ATTR_COLD void VVerifyTop_GrantBuffer___stl_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__0(VVerifyTop_GrantBuffer* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___stl_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__0\n"); );
...
VL_ATTR_COLD void VVerifyTop_GrantBuffer___stl_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__0(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___stl_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ io_prefetchResp_valid;
    io_prefetchResp_valid = 0;
