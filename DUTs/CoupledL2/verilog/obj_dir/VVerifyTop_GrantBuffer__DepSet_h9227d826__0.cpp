...
VL_INLINE_OPT void VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__0(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __PVT__grantQueue_io_deq_valid;
    __PVT__grantQueue_io_deq_valid = 0;
    ...
    if (VL_UNLIKELY(((~ (IData)(vlSymsp->TOP.reset)) 
                     & ((IData)(vlSelfRef.__PVT__full) 
                        & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid))))) {
    ...
    if (VL_UNLIKELY((1U & ((~ (IData)(vlSymsp->TOP.reset)) 
                           & (~ (IData)(vlSelfRef.__PVT__pftRespQueue_io_enq_ready)))))) {
        VL_FWRITEF_NX(0x80000002U,"Assertion failed: pftRespQueue should never be full, no back pressure logic\n    at GrantBuffer.scala:241 assert(pftRespQueue.get.io.enq.ready, \"pftRespQueue should never be full, no back pressure logic\")\n",0);
    }
    if (VL_UNLIKELY(((~ (IData)(vlSymsp->TOP.reset)) 
    ...
    if (vlSymsp->TOP.reset) {
        ...
        vlSelfRef.__PVT__pftRespQueue__DOT__maybe_full = 0U;
        ...
        vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value = 0U;
        vlSelfRef.__PVT__pftRespQueue__DOT__enq_ptr_value = 0U;
        ...
        vlSelfRef.__PVT__counter_52 = ((IData)(vlSelfRef.__PVT__helper_12_clean)
                                        ? 0ULL : vlSelfRef.__PVT__next_counter_4);
        if (((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__do_enq) 
             != (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__do_deq))) {
            vlSelfRef.__PVT__pftRespQueue__DOT__maybe_full 
                = ((1U & (~ (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__empty))) 
                   && (IData)(vlSelfRef.__PVT__pftRespQueue__DOT___do_enq_T));
        }
        if (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
             & ((2U == (3U & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode) 
                              >> 1U))) | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_mergeA)))) {
            if ((3U == (IData)(vlSelfRef.__PVT__inflight_insertIdx))) {
                vlSelfRef.__PVT__inflightGrant_3_bits_tag 
                    = vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_tag;
                vlSelfRef.__PVT__inflightGrant_3_bits_set 
                    = vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_set;
            }
        ...
        if (vlSelfRef.__PVT__pftRespQueue__DOT__do_deq) {
            vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value 
                = ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__wrap_1)
                    ? 0U : (IData)(vlSelfRef.__PVT__pftRespQueue__DOT___value_T_3));
        }
        if (vlSelfRef.__PVT__pftRespQueue__DOT__do_enq) {
            vlSelfRef.__PVT__pftRespQueue__DOT__enq_ptr_value 
                = ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__wrap)
                    ? 0U : (IData)(vlSelfRef.__PVT__pftRespQueue__DOT___value_T_1));
        }
    ...
    vlSelfRef.__PVT__pftRespQueue__DOT__wrap_1 = (9U 
                                                  == (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value));
    vlSelfRef.__PVT__pftRespQueue__DOT___value_T_3 
        = (0xfU & ((IData)(1U) + (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value)));
    vlSelfRef.__PVT__pftRespQueue__DOT__wrap = (9U 
                                                == (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__enq_ptr_value));
    vlSelfRef.__PVT__pftRespQueue__DOT___value_T_1 
        = (0xfU & ((IData)(1U) + (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__enq_ptr_value)));
    vlSelfRef.__PVT__pftRespQueue__DOT__ptr_diff = 
        (0xfU & ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__enq_ptr_value) 
                 - (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value)));
    vlSelfRef.__PVT__pftRespQueue__DOT__ptr_match = 
        ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value) 
         == (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__enq_ptr_value));
    vlSelfRef.__PVT__grantQueue__DOT___value_T_1 = 
    ...
    vlSelfRef.__PVT__pftRespQueue_io_enq_ready = (1U 
                                                  & (~ 
                                                     ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__ptr_match) 
                                                      & (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__maybe_full))));
    vlSelfRef.__PVT__pftRespQueue__DOT__empty = ((~ (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__maybe_full)) 
                                                 & (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__ptr_match));
    __PVT__grantQueue_io_deq_valid = (1U & (~ ((~ (IData)(vlSelfRef.__PVT__grantQueue__DOT__maybe_full)) 
    ...
    vlSelfRef.__PVT__next_counter = (vlSelfRef.__PVT__counter 
                                     + (QData)((IData)(__PVT__grantQueue_io_deq_valid)));
...
VL_INLINE_OPT void VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__1(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_INLINE_OPT void VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__2(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__grantBuf__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ io_prefetchResp_valid;
    io_prefetchResp_valid = 0;
    CData/*0:0*/ __PVT__pftRespQueue_io_enq_valid;
    __PVT__pftRespQueue_io_enq_valid = 0;
    ...
    CData/*2:0*/ __PVT___noSpaceWaitSinkEForSinkReq_T_21;
    __PVT___noSpaceWaitSinkEForSinkReq_T_21 = 0;
    // Body
    __PVT___noSpaceWaitSinkEForSinkReq_T_2 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                              & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel));
    __PVT___noSpaceForSinkReq_T_5 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                     & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel) 
                                        | ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel) 
                                           >> 2U)));
    vlSelfRef.__PVT__grantQueue__DOT__ram_task_opcode_MPORT_en 
        = ((~ (IData)(vlSelfRef.__PVT__full)) & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
                                                 & ((2U 
                                                     != (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode)) 
                                                    | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_mergeA))));
    vlSelfRef.__PVT___T_30 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
                              & ((2U == (3U & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode) 
                                               >> 1U))) 
                                 | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_mergeA)));
    __PVT__pftRespQueue_io_enq_valid = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
                                        & ((2U == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode)) 
                                           & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_status_vec_toD_2_valid)
                                               ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.__PVT__task_s5_bits_fromL2pft)
                                               : ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.__PVT__d_arb_io_in_1_valid)
                                                   ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.__PVT__task_s4_bits_fromL2pft)
                                                   : (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.__PVT__task_s3_bits_fromL2pft)))));
    __PVT___noSpaceWaitSinkEForSinkReq_T_21 = (7U & 
                                               ((3U 
                                                 & ((IData)(__PVT___noSpaceWaitSinkEForSinkReq_T_2) 
                                                    + 
                                                    VL_SHIFTR_III(2,2,32, 
                                                                  ((((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_status_vec_toD_0_valid) 
                                                ...
                                                + (3U 
                                                   & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1__DOT__slices_0__DOT__mainPipe.io_status_vec_toD_1_valid) 
    ...
    if (vlSelfRef.__PVT___T_30) {
        vlSelfRef.__PVT___GEN_66 = ((0U == (IData)(vlSelfRef.__PVT__inflight_insertIdx)) 
                                    | (IData)(vlSelfRef.__PVT__inflightGrant_0_valid));
        vlSelfRef.__PVT___GEN_67 = ((1U == (IData)(vlSelfRef.__PVT__inflight_insertIdx)) 
                                    | (IData)(vlSelfRef.__PVT__inflightGrant_1_valid));
        vlSelfRef.__PVT___GEN_68 = ((2U == (IData)(vlSelfRef.__PVT__inflight_insertIdx)) 
                                    | (IData)(vlSelfRef.__PVT__inflightGrant_2_valid));
        vlSelfRef.__PVT___GEN_69 = ((3U == (IData)(vlSelfRef.__PVT__inflight_insertIdx)) 
                                    | (IData)(vlSelfRef.__PVT__inflightGrant_3_valid));
    } else {
        vlSelfRef.__PVT___GEN_66 = vlSelfRef.__PVT__inflightGrant_0_valid;
        vlSelfRef.__PVT___GEN_67 = vlSelfRef.__PVT__inflightGrant_1_valid;
        vlSelfRef.__PVT___GEN_68 = vlSelfRef.__PVT__inflightGrant_2_valid;
        vlSelfRef.__PVT___GEN_69 = vlSelfRef.__PVT__inflightGrant_3_valid;
    }
    io_prefetchResp_valid = (1U & ((~ (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__empty)) 
                                   | (IData)(__PVT__pftRespQueue_io_enq_valid)));
    vlSelfRef.__PVT__pftRespQueue__DOT___do_enq_T = 
        ((IData)(vlSelfRef.__PVT__pftRespQueue_io_enq_ready) 
         & (IData)(__PVT__pftRespQueue_io_enq_valid));
    vlSelfRef.__PVT___noSpaceWaitSinkEForSinkReq_T_30 
        = (7U & ((IData)(__PVT___noSpaceWaitSinkEForSinkReq_T_21) 
                 + ((3U & ((IData)(vlSelfRef.__PVT__inflightGrant_0_valid) 
                           + (IData)(vlSelfRef.__PVT__inflightGrant_1_valid))) 
                    + (3U & ((IData)(vlSelfRef.__PVT__inflightGrant_2_valid) 
                             + (IData)(vlSelfRef.__PVT__inflightGrant_3_valid))))));
    vlSelfRef.__PVT___noSpaceForSinkPft_T_24 = (0xfU 
                                                & ((IData)(__PVT___noSpaceWaitSinkEForSinkReq_T_21) 
                                                   + 
                                                   ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__ptr_match)
                                                     ? 
                                                    ((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__maybe_full)
                                                    ...
                                                    (((IData)(vlSelfRef.__PVT__pftRespQueue__DOT__deq_ptr_value) 
                                                      ...
                                                      ? 
                                                     ((IData)(0xaU) 
                                                      + (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__ptr_diff))
                                                      : (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__ptr_diff)))));
    vlSelfRef.__PVT__pftRespQueue__DOT__do_deq = ((~ (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__empty)) 
                                                  & (IData)(io_prefetchResp_valid));
    vlSelfRef.__PVT__pftRespQueue__DOT__do_enq = ((1U 
                                                   & (~ (IData)(vlSelfRef.__PVT__pftRespQueue__DOT__empty))) 
                                                  && (IData)(vlSelfRef.__PVT__pftRespQueue__DOT___do_enq_T));
    vlSelfRef.__PVT__next_counter_4 = (vlSelfRef.__PVT__counter_52 
                                       + (QData)((IData)(
                                                         (9U 
                                                          <= (IData)(vlSelfRef.__PVT___noSpaceForSinkPft_T_24)))));
    vlSelfRef.io_toReqArb_blockSinkReqEntrance_blockA_s1 
        = ((4U <= (IData)(vlSelfRef.__PVT___noSpaceForSinkReq_T_36)) 
           | ((4U <= (IData)(vlSelfRef.__PVT___noSpaceWaitSinkEForSinkReq_T_30)) 
              | (0xaU <= (IData)(vlSelfRef.__PVT___noSpaceForSinkPft_T_24))));
}

VL_INLINE_OPT void VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__0(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __PVT__grantQueue_io_deq_valid;
    __PVT__grantQueue_io_deq_valid = 0;
    ...
    if (VL_UNLIKELY(((~ (IData)(vlSymsp->TOP.reset)) 
                     & ((IData)(vlSelfRef.__PVT__full) 
                        & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid))))) {
        VL_FWRITEF_NX(0x80000002U,"Assertion failed: GrantBuf full and RECEIVE new task, back pressure failed\n    at GrantBuffer.scala:159 assert(!(full && io.d_task.valid), \"GrantBuf full and RECEIVE new task, back pressure failed\")\n",0);
    }
    if (VL_UNLIKELY(((IData)(vlSelfRef.__PVT__helper_dump) 
                     & (~ (IData)(vlSymsp->TOP.reset))))) {
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
             & ((2U == (3U & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode) 
                              >> 1U))) | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_mergeA)))) {
            if ((3U == (IData)(vlSelfRef.__PVT__inflight_insertIdx))) {
                vlSelfRef.__PVT__inflightGrant_3_bits_tag 
                    = vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_tag;
                vlSelfRef.__PVT__inflightGrant_3_bits_set 
                    = vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_set;
            }
            if ((2U == (IData)(vlSelfRef.__PVT__inflight_insertIdx))) {
                vlSelfRef.__PVT__inflightGrant_2_bits_tag 
                    = vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_tag;
...
VL_INLINE_OPT void VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__1(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.io_toReqArb_blockSinkReqEntrance_blockB_s1 
        = (((IData)(vlSelfRef.__PVT__inflightGrant_0_valid) 
...
VL_INLINE_OPT void VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__2(VVerifyTop_GrantBuffer* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_GrantBuffer___nba_sequent__TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__grantBuf__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ io_prefetchResp_valid;
    io_prefetchResp_valid = 0;
    ...
    __PVT___noSpaceWaitSinkEForSinkReq_T_21 = 0;
    // Body
    __PVT___noSpaceWaitSinkEForSinkReq_T_2 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                              & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel));
    __PVT___noSpaceForSinkReq_T_5 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                     & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel) 
                                        | ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel) 
                                           >> 2U)));
    vlSelfRef.__PVT__grantQueue__DOT__ram_task_opcode_MPORT_en 
        = ((~ (IData)(vlSelfRef.__PVT__full)) & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
                                                 & ((2U 
                                                     != (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode)) 
                                                    | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_mergeA))));
    vlSelfRef.__PVT___T_30 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
                              & ((2U == (3U & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode) 
                                               >> 1U))) 
                                 | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_mergeA)));
    __PVT__pftRespQueue_io_enq_valid = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_valid) 
                                        & ((2U == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_toSourceD_bits_task_opcode)) 
                                           & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_status_vec_toD_2_valid)
                                               ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.__PVT__task_s5_bits_fromL2pft)
                                               : ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.__PVT__d_arb_io_in_1_valid)
                                                   ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.__PVT__task_s4_bits_fromL2pft)
                                                   : (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.__PVT__task_s3_bits_fromL2pft)))));
    __PVT___noSpaceWaitSinkEForSinkReq_T_21 = (7U & 
                                               ((3U 
                                                 & ((IData)(__PVT___noSpaceWaitSinkEForSinkReq_T_2) 
                                                    + 
                                                    VL_SHIFTR_III(2,2,32, 
                                                                  ((((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_status_vec_toD_0_valid) 
                                                                     & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.__PVT__task_s3_bits_channel)) 
                                                                    << 1U) 
                                                                   | (IData)(__PVT___noSpaceWaitSinkEForSinkReq_T_2)), 1U))) 
                                                + (3U 
                                                   & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2AsL1_1__DOT__slices_0__DOT__mainPipe.io_status_vec_toD_1_valid) 
