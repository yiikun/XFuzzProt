...
VL_ATTR_COLD void VVerifyTop_RequestBuffer_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__a_reqBuf__0(VVerifyTop_RequestBuffer_2* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_RequestBuffer_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__a_reqBuf__0\n"); );
...
VL_ATTR_COLD void VVerifyTop_RequestBuffer_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__a_reqBuf__0(VVerifyTop_RequestBuffer_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_RequestBuffer_2___stl_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__a_reqBuf__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __PVT___mergeAMask_T_74;
    __PVT___mergeAMask_T_74 = 0;
