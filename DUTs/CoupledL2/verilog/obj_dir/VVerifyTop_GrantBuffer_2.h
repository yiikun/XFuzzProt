...
#ifndef VERILATED_VVERIFYTOP_GRANTBUFFER_2_H_
#define VERILATED_VVERIFYTOP_GRANTBUFFER_2_H_  // guard
...
class alignas(VL_CACHE_LINE_BYTES) VVerifyTop_GrantBuffer_2 final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        VL_IN8(io_d_task_bits_task_set,1,0);
        VL_IN8(io_d_task_bits_task_tag,1,0);
        VL_IN8(io_d_task_bits_task_opcode,2,0);
        VL_IN8(io_d_task_bits_task_param,2,0);
        VL_IN8(io_d_task_bits_task_sourceId,7,0);
        ...
        VL_OUT8(io_grantStatus_0_set,1,0);
        VL_OUT8(io_grantStatus_0_tag,1,0);
        VL_OUT8(io_grantStatus_1_valid,0,0);
        VL_OUT8(io_grantStatus_1_set,1,0);
        VL_OUT8(io_grantStatus_1_tag,1,0);
        VL_OUT8(io_grantStatus_2_valid,0,0);
        VL_OUT8(io_grantStatus_2_set,1,0);
        VL_OUT8(io_grantStatus_2_tag,1,0);
        VL_OUT8(io_grantStatus_3_valid,0,0);
        VL_OUT8(io_grantStatus_3_set,1,0);
        VL_OUT8(io_grantStatus_3_tag,1,0);
        CData/*0:0*/ __PVT__grantQueue_io_deq_valid;
        CData/*2:0*/ __PVT__grantQueue_io_deq_bits_task_opcode;
    ...
    struct {
        ...
        CData/*1:0*/ __PVT__inflightGrant_0_bits_set;
        CData/*1:0*/ __PVT__inflightGrant_0_bits_tag;
        CData/*0:0*/ __PVT__inflightGrant_1_valid;
        CData/*1:0*/ __PVT__inflightGrant_1_bits_set;
        CData/*1:0*/ __PVT__inflightGrant_1_bits_tag;
        CData/*0:0*/ __PVT__inflightGrant_2_valid;
        CData/*1:0*/ __PVT__inflightGrant_2_bits_set;
        CData/*1:0*/ __PVT__inflightGrant_2_bits_tag;
        CData/*0:0*/ __PVT__inflightGrant_3_valid;
        CData/*1:0*/ __PVT__inflightGrant_3_bits_set;
        CData/*1:0*/ __PVT__inflightGrant_3_bits_tag;
        CData/*1:0*/ __PVT__inflight_insertIdx;
        CData/*0:0*/ __PVT__full;
        CData/*0:0*/ __PVT__grantBufValid;
        CData/*2:0*/ __PVT__grantBuf_task_opcode;
        CData/*2:0*/ __PVT__grantBuf_task_param;
        CData/*7:0*/ __PVT__grantBuf_task_sourceId;
        CData/*7:0*/ __PVT__grantBuf_data_data;
        CData/*7:0*/ __PVT__grantBuf_grantid;
        ...
        CData/*0:0*/ __PVT__grantQueue__DOT__do_deq;
        CData/*1:0*/ __PVT__grantQueue__DOT___value_T_1;
        CData/*1:0*/ __PVT__grantQueue__DOT___value_T_3;
    ...
    struct {
        ...
        VlUnpacked<CData/*2:0*/, 4> __PVT__grantQueue__DOT__ram_task_opcode;
        VlUnpacked<CData/*2:0*/, 4> __PVT__grantQueue__DOT__ram_task_param;
        VlUnpacked<CData/*7:0*/, 4> __PVT__grantQueue__DOT__ram_task_sourceId;
        VlUnpacked<SData/*15:0*/, 4> __PVT__grantQueue__DOT__ram_data_data;
        VlUnpacked<CData/*7:0*/, 4> __PVT__grantQueue__DOT__ram_grantid;
    };
    ...
    // CONSTRUCTORS
    VVerifyTop_GrantBuffer_2(VVerifyTop__Syms* symsp, const char* v__name);
    ~VVerifyTop_GrantBuffer_2();
    VL_UNCOPYABLE(VVerifyTop_GrantBuffer_2);
