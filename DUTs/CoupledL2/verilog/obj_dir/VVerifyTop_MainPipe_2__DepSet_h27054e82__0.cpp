...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__0(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__0\n"); );
    ...
    QData/*63:0*/ __Vdly__counter_28;
    __Vdly__counter_28 = 0;
    CData/*7:0*/ __VdlyVal__customL1Hint__DOT__hintQueue__DOT__ram_source__v0;
    ...
    CData/*7:0*/ __VdlyVal__customL1Hint__DOT__hint_s1Queue__DOT__ram_source__v0;
    ...
    __Vdly__counter_28 = vlSelfRef.__PVT__counter_28;
    ...
    __Vdly__counter_28 = ((IData)(vlSymsp->TOP.reset)
                           ? 0ULL : ((IData)(vlSelfRef.__PVT__helper_21_clean)
                                      ? 0ULL : vlSelfRef.__PVT__counter_28));
    ...
    if (VL_UNLIKELY(((IData)(vlSelfRef.__PVT__helper_12_dump) 
        ...
        VL_FWRITEF_NX(0x80000002U,"[PERF ][time=%20#] __PERCENTAGE_M__: acquire_miss, %20#\n",0,
                      ...
                      64,vlSelfRef.__PVT__next_counter_12);
    }
    if (VL_UNLIKELY(((IData)(vlSelfRef.__PVT__helper_13_dump) 
        ...
        VL_FWRITEF_NX(0x80000002U,"[PERF ][time=%20#] __PERCENTAGE_M__: get_miss, %20#\n",0,
                      ...
                      64,vlSelfRef.__PVT__next_counter_13);
    }
    if (VL_UNLIKELY(((IData)(vlSelfRef.__PVT__helper_14_dump) 
        ...
        VL_FWRITEF_NX(0x80000002U,"[PERF ][time=%20#] __PERCENTAGE_M__: b_req_hit, %20#\n",0,
                      ...
                      64,vlSelfRef.__PVT__next_counter_14);
    }
    if (VL_UNLIKELY(((IData)(vlSelfRef.__PVT__helper_15_dump) 
        ...
        VL_FWRITEF_NX(0x80000002U,"[PERF ][time=%20#] __PERCENTAGE_M__: b_req_miss, %20#\n",0,
                      ...
                      64,vlSelfRef.__PVT__next_counter_15);
    }
    ...
    if (vlSymsp->TOP.reset) {
        ...
        vlSelfRef.__PVT__task_s5_bits_dirty = 0U;
        ...
        vlSelfRef.__PVT__task_s4_bits_dirty = 0U;
        ...
        vlSelfRef.__PVT__task_s3_bits_dirty = 0U;
        ...
        if (vlSelfRef.__PVT___task_s5_valid_T_1) {
            ...
            vlSelfRef.__PVT__task_s5_bits_dirty = vlSelfRef.__PVT__task_s4_bits_dirty;
        ...
        if (vlSelfRef.__PVT__helper_16_clean) {
            ...
            if (((IData)(vlSelfRef.__PVT___T_103) & 
                 (1U > (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_way)))) {
        ...
        if (vlSelfRef.__PVT___task_s4_valid_T_1) {
            ...
            vlSelfRef.__PVT__task_s4_bits_dirty = vlSelfRef.__PVT__task_s3_bits_dirty;
            ...
            vlSelfRef.__PVT__task_s4_bits_mshrId = 
                (0xffU & ((IData)(vlSelfRef.__PVT___req_drop_s3_T_2)
                           ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mshrCtl_io_toMainPipe_mshr_alloc_ptr)
        ...
        if (vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
            vlSelfRef.__PVT__task_s3_bits_useProbeData 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_useProbeData;
            vlSelfRef.__PVT__task_s3_bits_way = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_way;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_accessed 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_accessed;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_alias 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_alias;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_clients 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_clients;
            vlSelfRef.__PVT__task_s3_bits_meta_dirty 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_dirty;
            vlSelfRef.__PVT__task_s3_bits_meta_clients 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_clients;
            vlSelfRef.__PVT__task_s3_bits_meta_alias 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_alias;
            vlSelfRef.__PVT__task_s3_bits_meta_accessed 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_accessed;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_dirty 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_dirty;
            vlSelfRef.__PVT__task_s3_bits_meta_state 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_state;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_state 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_state;
            vlSelfRef.__PVT__task_s3_bits_dsWen = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_dsWen;
            vlSelfRef.__PVT__task_s3_bits_replTask 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_replTask;
            vlSelfRef.__PVT__task_s3_bits_tagWen = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_tagWen;
            vlSelfRef.__PVT__task_s3_bits_metaWen = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_metaWen;
            vlSelfRef.__PVT__task_s3_bits_alias = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_alias;
            vlSelfRef.__PVT__task_s3_bits_dirty = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_dirty;
            vlSelfRef.__PVT__task_s3_bits_mergeA = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mergeA;
            vlSelfRef.__PVT__task_s3_bits_mshrId = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mshrId;
            vlSelfRef.__PVT__task_s3_bits_mshrTask 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mshrTask;
        }
    }
    if (vlSelfRef.__PVT___task_s5_valid_T_1) {
    ...
    vlSelfRef.__PVT__counter_28 = __Vdly__counter_28;
    vlSelfRef.__PVT__customL1Hint__DOT__hintQueue__DOT___value_T_3 
    ...
    vlSelfRef.__PVT__c_d_valid_s5 = ((~ ((IData)(vlSelfRef.__PVT__c_d_valid_s5_REG) 
    ...
    vlSelfRef.io_status_vec_toC_2_valid = ((IData)(vlSelfRef.__PVT__c_d_valid_s5) 
    ...
    vlSelfRef.__PVT__c_d_valid_s4 = ((~ (IData)(vlSelfRef.__PVT__c_d_valid_s4_REG)) 
                                     & (IData)(vlSelfRef.__PVT__task_s4_valid));
    ...
    vlSelfRef.__PVT__c_arb_io_in_1_valid = ((IData)(vlSelfRef.__PVT__c_d_valid_s4) 
    ...
    vlSelfRef.__PVT__customL1Hint__DOT__hintQueue__DOT__do_deq 
        = ((IData)(vlSelfRef.__PVT__customL1Hint__DOT__hintQueue_io_deq_valid) 
           & (~ (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__l1HintArb_io_out_ready_REG)));
    vlSelfRef.c_arb__DOT____VdfgRegularize_hbadb2dd2_0_0 
    ...
    vlSelfRef.__PVT___chnl_fire_s4_T = (((~ (IData)(vlSelfRef.io_status_vec_toC_2_valid)) 
                                         & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sourceC__DOT__queue_io_enq_ready)) 
                                        & (IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid));
    vlSelfRef.io_toSourceC_bits_task_dirty = ((IData)(vlSelfRef.io_status_vec_toC_2_valid)
                                               ? (IData)(vlSelfRef.__PVT__task_s5_bits_dirty)
                                               : ((IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid)
                                                   ? (IData)(vlSelfRef.__PVT__task_s4_bits_dirty)
                                                   : (IData)(vlSelfRef.__PVT__task_s3_bits_dirty)));
    vlSelfRef.__PVT___io_toMSHRCtl_mshr_alloc_s3_valid_T_1 
        = ((~ (IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)) 
           & (IData)(vlSelfRef.__PVT__task_s3_valid));
}

VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__1(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__c_arb_io_in_0_bits_data_data = 
        ((IData)(vlSelfRef.__PVT__task_s5_bits_mshrTask)
          ? (IData)(vlSelfRef.__PVT__data_s5) : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__dataStorage__DOT__array_io_r_resp_data_0_data));
    vlSelfRef.__PVT__d_arb_io_in_1_valid = ((IData)(vlSelfRef.__PVT__c_d_valid_s4) 
                                            & (IData)(vlSelfRef.__PVT__isD_s4));
    vlSelfRef.io_status_vec_toD_2_valid = ((IData)(vlSelfRef.__PVT__c_d_valid_s5) 
                                           & (IData)(vlSelfRef.__PVT__isD_s5));
    vlSelfRef.io_nestedwbData_data = (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC.__PVT__REG___05F1) 
                                       << 8U) | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC.__PVT__REG___05F0));
    vlSelfRef.__PVT__retry = ((~ (IData)((0U != (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory__DOT__freeWayMask_s3)))) 
                              & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory__DOT__refillReqValid_s3));
    vlSelfRef.__PVT__need_repl = ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory__DOT__refillReqValid_s3) 
                                  & ((0U != (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_replResp_bits_meta_state)) 
    ...
    vlSelfRef.d_arb__DOT____VdfgRegularize_hbadb2dd2_0_0 
        = ((IData)(vlSelfRef.io_status_vec_toD_2_valid) 
           | (IData)(vlSelfRef.__PVT__d_arb_io_in_1_valid));
    if (vlSymsp->TOP.reset) {
        vlSelfRef.__PVT__task_s5_bits_sourceId = 0U;
        vlSelfRef.__PVT__task_s5_bits_aMergeTask_opcode = 0U;
        vlSelfRef.__PVT__task_s5_bits_aMergeTask_param = 0U;
        vlSelfRef.__PVT__task_s5_bits_aMergeTask_sourceId = 0U;
        ...
        if (vlSelfRef.__PVT___task_s5_valid_T_1) {
            vlSelfRef.__PVT__task_s5_bits_sourceId 
                = vlSelfRef.__PVT__task_s4_bits_sourceId;
            vlSelfRef.__PVT__task_s5_bits_aMergeTask_opcode 
                = vlSelfRef.__PVT__task_s4_bits_aMergeTask_opcode;
            vlSelfRef.__PVT__task_s5_bits_aMergeTask_param 
                = vlSelfRef.__PVT__task_s4_bits_aMergeTask_param;
            vlSelfRef.__PVT__task_s5_bits_aMergeTask_sourceId 
                = vlSelfRef.__PVT__task_s4_bits_aMergeTask_sourceId;
            vlSelfRef.__PVT__task_s5_bits_param = vlSelfRef.__PVT__task_s4_bits_param;
        }
        if (vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
            vlSelfRef.__PVT__task_s3_bits_tag = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_tag;
            vlSelfRef.__PVT__task_s3_bits_needProbeAckData 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_needProbeAckData;
            vlSelfRef.__PVT__task_s3_bits_set = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set;
        }
    }
    ...
    if (vlSymsp->TOP.reset) {
        vlSelfRef.__PVT__task_s4_bits_sourceId = 0U;
        vlSelfRef.__PVT__task_s4_bits_aMergeTask_opcode = 0U;
        vlSelfRef.__PVT__task_s4_bits_aMergeTask_param = 0U;
        vlSelfRef.__PVT__task_s4_bits_aMergeTask_sourceId = 0U;
        vlSelfRef.__PVT__task_s4_bits_channel = 0U;
        vlSelfRef.__PVT__task_s4_bits_opcode = 0U;
        vlSelfRef.__PVT__task_s4_bits_param = 0U;
        vlSelfRef.__PVT__task_s3_bits_aMergeTask_opcode = 0U;
        vlSelfRef.__PVT__task_s3_bits_aMergeTask_param = 0U;
        vlSelfRef.__PVT__task_s3_bits_aMergeTask_sourceId = 0U;
        ...
        if (vlSelfRef.__PVT___task_s4_valid_T_1) {
            vlSelfRef.__PVT__task_s4_bits_sourceId 
                = vlSelfRef.__PVT__task_s3_bits_sourceId;
            vlSelfRef.__PVT__task_s4_bits_aMergeTask_opcode 
                = vlSelfRef.__PVT__task_s3_bits_aMergeTask_opcode;
            vlSelfRef.__PVT__task_s4_bits_aMergeTask_param 
                = vlSelfRef.__PVT__task_s3_bits_aMergeTask_param;
            vlSelfRef.__PVT__task_s4_bits_aMergeTask_sourceId 
                = vlSelfRef.__PVT__task_s3_bits_aMergeTask_sourceId;
        ...
        if (vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_opcode 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_opcode;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_param 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_param;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_sourceId 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_sourceId;
            vlSelfRef.__PVT__task_s3_bits_param = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_param;
            vlSelfRef.__PVT__task_s3_bits_opcode = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_opcode;
        }
    }
    if (vlSelfRef.__PVT___task_s4_valid_T_1) {
        vlSelfRef.__PVT__data_s4 = ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe_io_releaseBufResp_s3_valid_REG)
                                     ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__releaseBuf_io_resp_data_data)
                                     : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__refillBuf_io_resp_data_data));
    }
    ...
    vlSelfRef.__PVT___GEN_53 = ((7U == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode))
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__2(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.io_toDS_wdata_s3_data = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)
                                        ? ((IData)(vlSelfRef.__PVT__task_s3_bits_useProbeData)
                                            ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__releaseBuf_io_resp_data_data)
                                            : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__refillBuf_io_resp_data_data))
                                        : (IData)(vlSelfRef.io_nestedwbData_data));
    vlSelfRef.__PVT__c_arb_io_in_2_bits_data_data = 
        ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe_io_releaseBufResp_s3_valid_REG)
          ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__releaseBuf_io_resp_data_data)
          : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__refillBuf_io_resp_data_data));
    vlSelfRef.__VdfgRegularize_hb02e9cef_0_7 = (1U 
                                                & (~ 
                                                   ((~ (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_metaWen)) 
                                                    & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mshrTask))));
    vlSelfRef.io_toSourceC_bits_data_data = ((IData)(vlSelfRef.io_status_vec_toC_2_valid)
                                              ? (IData)(vlSelfRef.__PVT__c_arb_io_in_0_bits_data_data)
                                              : ((IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid)
                                                  ? (IData)(vlSelfRef.__PVT__data_s4)
                                                  : (IData)(vlSelfRef.__PVT__c_arb_io_in_2_bits_data_data)));
}

VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__3(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__3\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    __PVT__miss_s3 = 0;
    CData/*0:0*/ __VdfgRegularize_hb02e9cef_0_5;
    __VdfgRegularize_hb02e9cef_0_5 = 0;
    CData/*0:0*/ __PVT__customL1Hint__DOT___chn_Grant_s3_T_3;
    __PVT__customL1Hint__DOT___chn_Grant_s3_T_3 = 0;
    // Body
    __PVT__hit_s3 = ((IData)(vlSelfRef.__PVT___io_toMSHRCtl_mshr_alloc_s3_valid_T_1) 
                     & (0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)));
    __PVT__miss_s3 = ((~ (IData)((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)))) 
    ...
    __PVT___sink_resp_s3_bits_param_T_6 = (((IData)(vlSelfRef.__PVT__task_s3_bits_param) 
                                            << 2U) 
                                           | (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state));
    __PVT__sink_resp_s3_a_promoteT = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)) 
                                      & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state) 
                                         >> 1U));
    __VdfgRegularize_hb02e9cef_0_5 = (((3U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                       & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_dirty)) 
    ...
    } else if (vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
        vlSelfRef.__PVT__task_s3_bits_reqSource = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_reqSource;
        vlSelfRef.__PVT__task_s3_bits_sourceId = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_sourceId;
        vlSelfRef.__PVT__task_s3_bits_off = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_off;
        vlSelfRef.__PVT__task_s3_bits_channel = vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel;
    }
    ...
    vlSelfRef.__PVT__next_counter_15 = (vlSelfRef.__PVT__counter_15 
                                        + (QData)((IData)(
                                                          ((IData)(__PVT__miss_s3) 
                                                           & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                                              >> 1U)))));
    vlSelfRef.__PVT___T_46 = ((IData)(__PVT__hit_s3) 
                              & (IData)(vlSelfRef.__PVT__task_s3_bits_channel));
    vlSelfRef.__PVT___T_70 = ((IData)(__PVT__miss_s3) 
                              & (IData)(vlSelfRef.__PVT__task_s3_bits_channel));
    ...
    vlSelfRef.io_nestedwb_c_set_dirty = ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                         & (((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                             >> 2U) 
                                            & (7U == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode))));
    __PVT__sinkB_req_s3 = (1U & ((~ (IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)) 
                                 & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                    >> 1U)));
    __PVT__sinkC_req_s3 = ((~ (IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)) 
                           & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                              >> 2U));
    __PVT___mshr_probeack_s3_T_2 = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask) 
                                    & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                       >> 1U));
    __PVT__need_mshr_s3_b = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)) 
                             & (((~ (((1U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                      | (3U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state))) 
                                     & (1U == (IData)(vlSelfRef.__PVT__task_s3_bits_param)))) 
                                 & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                    >> 1U)) & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_clients)));
    __PVT__sinkA_req_s3 = (1U & ((~ (IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)) 
                                 & (IData)(vlSelfRef.__PVT__task_s3_bits_channel)));
    __PVT___mshr_grant_s3_T_2 = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask) 
                                 & (IData)(vlSelfRef.__PVT__task_s3_bits_channel));
    if ((2U & (IData)(vlSelfRef.__PVT__task_s3_bits_channel))) {
        vlSelfRef.__PVT___GEN_55 = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13))
                                         ...
                                         ? 3U : ((7U 
                                                 ...
                                                 ((0xbU 
                                                  ...
                                                  ((9U 
                                                    ...
                                                    : 4U))))
                                     : 5U);
        vlSelfRef.__PVT___GEN_54 = (((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)) 
                                     & (IData)(__VdfgRegularize_hb02e9cef_0_5))
                                     ? 5U : 4U);
    } else {
        vlSelfRef.__PVT___GEN_55 = 0U;
        vlSelfRef.__PVT___GEN_54 = 6U;
    }
    ...
    vlSelfRef.__PVT__next_counter_13 = (vlSelfRef.__PVT__counter_13 
                                        + (QData)((IData)(
                                                          ((IData)(vlSelfRef.__PVT___T_70) 
                                                           & (4U 
                                                              == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode))))));
    __PVT__need_data_b = ((IData)(__PVT__sinkB_req_s3) 
                          & ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)) 
                             & ((2U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                | (IData)(__VdfgRegularize_hb02e9cef_0_5))));
    vlSelfRef.__PVT__wen_c = ((IData)(__PVT__sinkC_req_s3) 
                              & ((IData)(vlSelfRef.__PVT___wen_c_T_4) 
                                 & ((IData)(vlSelfRef.__PVT__task_s3_bits_opcode) 
                                    & (0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)))));
    vlSelfRef.__PVT__metaW_valid_s3_c = ((IData)(__PVT__sinkC_req_s3) 
                                         & (0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)));
    vlSelfRef.__PVT__next_counter_5 = (vlSelfRef.__PVT__counter_5 
                                       + (QData)((IData)(
                                                         ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                                          & ((IData)(__PVT___mshr_probeack_s3_T_2) 
                                                             & (5U 
                                                                == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode)))))));
    __PVT__mshr_probeack_s3 = ((IData)(__PVT___mshr_probeack_s3_T_2) 
                               & (4U == (6U & (IData)(vlSelfRef.__PVT__task_s3_bits_opcode))));
    vlSelfRef.__PVT__req_prefetch_s3 = ((IData)(__PVT__sinkA_req_s3) 
                                        & (5U == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode)));
    __PVT__req_acquire_s3 = ((IData)(__PVT__sinkA_req_s3) 
                             & (IData)(vlSelfRef.__PVT___req_acquire_s3_T_2));
    vlSelfRef.__PVT__req_get_s3 = ((IData)(__PVT__sinkA_req_s3) 
                                       ...
                                       + (QData)((IData)(
                                                         ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                                          & ((~ (IData)(vlSelfRef.__PVT__retry)) 
                                                             & ((IData)(__PVT___mshr_grant_s3_T_2) 
                                                                & (5U 
                                                                   == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode))))))));
    __PVT__mshr_grant_s3 = ((IData)(__PVT___mshr_grant_s3_T_2) 
                            & (4U == (6U & (IData)(vlSelfRef.__PVT__task_s3_bits_opcode))));
    __PVT__mshr_accessackdata_s3 = ((IData)(__PVT___mshr_grant_s3_T_2) 
                                    & (1U == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode)));
    __PVT__mshr_hintack_s3 = ((IData)(__PVT___mshr_grant_s3_T_2) 
                              & (2U == (IData)(vlSelfRef.__PVT__task_s3_bits_opcode)));
    vlSelfRef.__PVT__next_counter_4 = (vlSelfRef.__PVT__counter_4 
                                       + (QData)((IData)(
                                                         ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                                          & (IData)(__PVT__mshr_probeack_s3)))));
    vlSelfRef.__PVT___isC_s3_T = ((IData)(vlSelfRef.__PVT__mshr_release_s3) 
                                  | (IData)(__PVT__mshr_probeack_s3));
    if (__PVT__req_acquire_s3) {
        vlSelfRef.__PVT___sink_resp_s3_bits_param_T_4 
        ...
        vlSelfRef.io_toMSHRCtl_mshr_alloc_s3_bits_task_aliasTask 
            = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)) 
               & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_clients) 
                  & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_alias) 
    ...
    vlSelfRef.__PVT__next_counter = (vlSelfRef.__PVT__counter 
                                     + (QData)((IData)(
                                                       ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                                        & ((~ (IData)(vlSelfRef.__PVT__retry)) 
                                                           & (IData)(__PVT__mshr_grant_s3))))));
    vlSelfRef.__PVT__next_counter_2 = (vlSelfRef.__PVT__counter_2 
                                       + (QData)((IData)(
                                                         ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                                          & ((~ (IData)(vlSelfRef.__PVT__retry)) 
                                                             & (IData)(__PVT__mshr_accessackdata_s3))))));
    vlSelfRef.__PVT__next_counter_3 = (vlSelfRef.__PVT__counter_3 
                                       + (QData)((IData)(
                                                         ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                                          & ((~ (IData)(vlSelfRef.__PVT__retry)) 
                                                             & (IData)(__PVT__mshr_hintack_s3))))));
    __PVT__mshr_refill_s3 = ((IData)(__PVT__mshr_accessackdata_s3) 
                             | ((IData)(__PVT__mshr_hintack_s3) 
                                | (IData)(__PVT__mshr_grant_s3)));
    ...
    __PVT___need_write_releaseBuf_T = ((IData)(__PVT__need_probe_s3_a) 
                                       | (IData)(vlSelfRef.io_toMSHRCtl_mshr_alloc_s3_bits_task_aliasTask));
    __PVT___io_toDS_req_s3_bits_way_T = ((IData)(__PVT__mshr_refill_s3) 
                                         & (IData)(vlSelfRef.__PVT__task_s3_bits_replTask));
    vlSelfRef.io_toDS_req_s3_bits_wen = ((IData)(vlSelfRef.__PVT__wen_c) 
                                         | ((IData)(vlSelfRef.__PVT__task_s3_bits_dsWen) 
                                            & ((IData)(__PVT__mshr_probeack_s3) 
                                               | ((IData)(vlSelfRef.__PVT__mshr_release_s3) 
                                                  | ((IData)(__PVT__mshr_refill_s3) 
                                                     & ((~ (IData)(vlSelfRef.__PVT__need_repl)) 
                                                        & (~ (IData)(vlSelfRef.__PVT__retry))))))));
    __PVT__need_data_mshr_repl = ((IData)(__PVT__mshr_refill_s3) 
                                  & ((~ (IData)(vlSelfRef.__PVT__retry)) 
                                     & (IData)(vlSelfRef.__PVT__need_repl)));
    __PVT___metaW_valid_s3_mshr_T_1 = ((IData)(__PVT__mshr_refill_s3) 
                                       & (IData)(vlSelfRef.__PVT__retry));
    ...
    if (__PVT___io_toDS_req_s3_bits_way_T) {
        vlSelfRef.io_tagWReq_bits_way = vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_replResp_bits_way;
        vlSelfRef.io_toDS_req_s3_bits_way = vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_replResp_bits_way;
    } else {
        ...
        vlSelfRef.io_toDS_req_s3_bits_way = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)
                                              ...
                                              : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_way));
    }
    ...
    vlSelfRef.__PVT__next_counter_10 = (vlSelfRef.__PVT__counter_10 
                                        + (QData)((IData)(__PVT___metaW_valid_s3_mshr_T_1)));
    ...
    vlSelfRef.__PVT___io_metaWReq_valid_T_1 = ((IData)(vlSelfRef.__PVT__metaW_valid_s3_a) 
                                               | ((~ (IData)(__PVT__need_mshr_s3_b)) 
                                                  & ((IData)(__PVT__sinkB_req_s3) 
                                                     & ((0U 
                                                         != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_13)) 
                                                        & ((3U 
                                                            == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                                           | ((1U 
                                                               == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
    ...
    vlSelfRef.io_metaWReq_valid = (1U & ((~ (IData)(vlSelfRef.__PVT__resetFinish)) 
                                         | ((IData)(vlSelfRef.__PVT__task_s3_valid) 
                                            & ((IData)(vlSelfRef.__PVT___io_metaWReq_valid_T_1) 
                                               | ((IData)(vlSelfRef.__PVT__metaW_valid_s3_c) 
                                                  | ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask) 
                                                     & ((~ (IData)(__PVT___metaW_valid_s3_mshr_T_1)) 
                                                        & (IData)(vlSelfRef.__PVT__task_s3_bits_metaWen))))))));
    if (vlSelfRef.__PVT__sink_resp_s3_valid) {
        ...
        if ((1U & (IData)(vlSelfRef.__PVT__task_s3_bits_channel))) {
            vlSelfRef.__PVT__c_arb_io_in_2_bits_task_param 
                = vlSelfRef.__PVT___sink_resp_s3_bits_param_T_4;
    ...
    if (vlSelfRef.io_status_vec_toC_2_valid) {
        ...
        vlSelfRef.io_toSourceC_bits_task_param = vlSelfRef.__PVT__c_arb_io_in_2_bits_task_param;
    ...
    __PVT___chnl_fire_s3_T_1 = ((~ (IData)(vlSelfRef.d_arb__DOT____VdfgRegularize_hbadb2dd2_0_0)) 
                                & (IData)(__PVT__d_arb_io_in_2_valid));
    vlSelfRef.io_toSourceD_valid = ((IData)(vlSelfRef.d_arb__DOT____VdfgRegularize_hbadb2dd2_0_0) 
                                    | (IData)(__PVT__d_arb_io_in_2_valid));
    __PVT___chnl_fire_s3_T = (((~ (IData)(vlSelfRef.c_arb__DOT____VdfgRegularize_hbadb2dd2_0_0)) 
                               & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sourceC__DOT__queue_io_enq_ready)) 
                              & (IData)(__PVT__c_arb_io_in_2_valid));
    vlSelfRef.io_toSourceC_valid = ((IData)(vlSelfRef.c_arb__DOT____VdfgRegularize_hbadb2dd2_0_0) 
                                    | (IData)(__PVT__c_arb_io_in_2_valid));
    vlSelfRef.__PVT__sourceD_pipe_len = (((IData)(vlSelfRef.io_status_vec_toD_2_valid)
                                         ...
                                         | (((IData)(vlSelfRef.__PVT___chnl_fire_s4_T_1)
                                            ...
                                            | ((IData)(__PVT___chnl_fire_s3_T_1)
                                                ? 3U
                                                : 0U)));
    vlSelfRef.__PVT__sourceC_pipe_len = ((((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sourceC__DOT__queue_io_enq_ready) 
                                           & (IData)(vlSelfRef.io_status_vec_toC_2_valid))
                                           ? 5U : 0U) 
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__4(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__4\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.io_toReqArb_blockG_s1 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                       & ((IData)(vlSelfRef.__VdfgRegularize_hb02e9cef_0_7) 
                                          & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_bits_set) 
                                             == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set))));
    vlSelfRef.io_toReqArb_blockB_s1 = ((((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
    ...
    vlSelfRef.io_toReqArb_blockC_s1 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                       & ((IData)(vlSelfRef.__VdfgRegularize_hb02e9cef_0_7) 
                                          & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC.io_task_bits_set) 
                                             == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set))));
    vlSelfRef.io_toReqBuf_0 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                               & ((IData)(vlSelfRef.__VdfgRegularize_hb02e9cef_0_7) 
                                  & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkA_io_task_bits_set) 
                                     == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set))));
}

VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__5(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__mainPipe__5\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    ...
    // Body
    if (vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_mergeA) {
        vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue_io_enq_bits_source 
            = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_valid)
                ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_bits_aMergeTask_sourceId)
                : ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT___sinkValids_T_1)
                    ? 0U : (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT___chnl_task_s1_bits_T_4_aMergeTask_sourceId)));
        __PVT__customL1Hint__DOT___mshr_GrantData_s1_T_7 
            = (1U & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel));
    } else {
        vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue_io_enq_bits_source 
            = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_valid)
                ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_bits_sourceId)
                : ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT___sinkValids_T_1)
                    ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__sinkC.io_task_bits_sourceId)
                    : (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.__PVT___chnl_task_s1_bits_T_4_sourceId)));
        __PVT__customL1Hint__DOT___mshr_GrantData_s1_T_7 = 0U;
    }
    __PVT__customL1Hint__DOT___mshr_GrantData_s1_T 
        = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_mshrTask) 
           & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_valid));
    __PVT__customL1Hint__DOT__mshr_GrantData_s1 = ((IData)(__PVT__customL1Hint__DOT___mshr_GrantData_s1_T) 
                                                   & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel) 
                                                       & (5U 
                                                          == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode))) 
                                                      | ((IData)(__PVT__customL1Hint__DOT___mshr_GrantData_s1_T_7) 
                                                         & (5U 
                                                            == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_aMergeTask_opcode)))));
        ...
        = ((IData)(__PVT__customL1Hint__DOT__mshr_GrantData_s1) 
           | ((IData)(__PVT__customL1Hint__DOT__mshr_Grant_s1) 
              | ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_valid) 
                 & ((~ (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_mshrTask)) 
                    & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel) 
                        >> 2U) & ((6U == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode)) 
                                  | (7U == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode))))))));
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__0(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__0\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    VlUnpacked<CData/*0:0*/, 4> __PVT__customL1Hint__DOT__hintQueue__DOT__ram_isKeyword;
    for (int __Vi0 = 0; __Vi0 < 4; ++__Vi0) {
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if (vlSelfRef.__PVT__helper_16_clean) {
            ...
            if (((IData)(vlSelfRef.__PVT___T_103) & 
                 (1U > (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_way)))) {
                vlSelfRef.__PVT__counter_16 = vlSelfRef.__PVT___counter_T_17;
            }
            if (((IData)(vlSelfRef.__PVT___T_103) & 
                 (1U <= (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_way)))) {
        ...
        if (vlSelfRef.__PVT___task_s4_valid_T_1) {
            ...
            vlSelfRef.__PVT__task_s4_bits_mshrId = 
                (0xffU & ((IData)(vlSelfRef.__PVT___req_drop_s3_T_2)
                           ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mshrCtl_io_toMainPipe_mshr_alloc_ptr)
                           : ((IData)(vlSelfRef.__PVT__sink_resp_s3_valid)
                               ? ((IData)(0x80U) + (IData)(vlSelfRef.__PVT__task_s3_bits_sourceId))
                               : (IData)(vlSelfRef.__PVT__task_s3_bits_mshrId))));
            if (vlSelfRef.__PVT__task_s3_bits_mshrTask) {
        ...
        if (vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
            vlSelfRef.__PVT__task_s3_bits_useProbeData 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_useProbeData;
            vlSelfRef.__PVT__task_s3_bits_way = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_way;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_accessed 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_accessed;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_alias 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_alias;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_clients 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_clients;
            vlSelfRef.__PVT__task_s3_bits_meta_dirty 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_dirty;
            vlSelfRef.__PVT__task_s3_bits_meta_clients 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_clients;
            vlSelfRef.__PVT__task_s3_bits_meta_alias 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_alias;
            vlSelfRef.__PVT__task_s3_bits_meta_accessed 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_accessed;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_dirty 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_dirty;
            vlSelfRef.__PVT__task_s3_bits_meta_state 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_meta_state;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_meta_state 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_meta_state;
            vlSelfRef.__PVT__task_s3_bits_dsWen = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_dsWen;
            vlSelfRef.__PVT__task_s3_bits_replTask 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_replTask;
            vlSelfRef.__PVT__task_s3_bits_tagWen = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_tagWen;
            vlSelfRef.__PVT__task_s3_bits_metaWen = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_metaWen;
            vlSelfRef.__PVT__task_s3_bits_alias = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_alias;
            vlSelfRef.__PVT__task_s3_bits_dirty = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_dirty;
            vlSelfRef.__PVT__task_s3_bits_mergeA = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mergeA;
            vlSelfRef.__PVT__task_s3_bits_mshrId = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mshrId;
            vlSelfRef.__PVT__task_s3_bits_mshrTask 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mshrTask;
        }
    }
    if (vlSelfRef.__PVT___task_s5_valid_T_1) {
        vlSelfRef.__PVT__data_s5 = vlSelfRef.__PVT__data_s4;
    ...
    vlSelfRef.__PVT__customL1Hint__DOT__hintQueue__DOT__do_deq 
        = ((IData)(vlSelfRef.__PVT__customL1Hint__DOT__hintQueue_io_deq_valid) 
           & (~ (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__l1HintArb_io_out_ready_REG)));
    vlSelfRef.c_arb__DOT____VdfgRegularize_hbadb2dd2_0_0 
        = ((IData)(vlSelfRef.io_status_vec_toC_2_valid) 
           | (IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid));
    vlSelfRef.__PVT___chnl_fire_s4_T = (((~ (IData)(vlSelfRef.io_status_vec_toC_2_valid)) 
                                         & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sourceC__DOT__queue_io_enq_ready)) 
                                        & (IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid));
    vlSelfRef.io_toSourceC_bits_task_dirty = ((IData)(vlSelfRef.io_status_vec_toC_2_valid)
                                               ? (IData)(vlSelfRef.__PVT__task_s5_bits_dirty)
                                               : ((IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid)
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__1(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__1\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__PVT__c_arb_io_in_0_bits_data_data = 
        ((IData)(vlSelfRef.__PVT__task_s5_bits_mshrTask)
          ? (IData)(vlSelfRef.__PVT__data_s5) : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__dataStorage__DOT__array_io_r_resp_data_0_data));
    vlSelfRef.__PVT__d_arb_io_in_1_valid = ((IData)(vlSelfRef.__PVT__c_d_valid_s4) 
                                            & (IData)(vlSelfRef.__PVT__isD_s4));
    vlSelfRef.io_status_vec_toD_2_valid = ((IData)(vlSelfRef.__PVT__c_d_valid_s5) 
                                           & (IData)(vlSelfRef.__PVT__isD_s5));
    vlSelfRef.io_nestedwbData_data = (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC.__PVT__REG___05F1) 
                                       << 8U) | (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC.__PVT__REG___05F0));
    vlSelfRef.__PVT__retry = ((~ (IData)((0U != (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory__DOT__freeWayMask_s3)))) 
                              & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory__DOT__refillReqValid_s3));
    vlSelfRef.__PVT__need_repl = ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory__DOT__refillReqValid_s3) 
                                  & ((0U != (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_replResp_bits_meta_state)) 
                                     & (IData)(vlSelfRef.__PVT__task_s3_bits_replTask)));
    vlSelfRef.__PVT___chnl_fire_s4_T_1 = ((~ (IData)(vlSelfRef.io_status_vec_toD_2_valid)) 
                                          & (IData)(vlSelfRef.__PVT__d_arb_io_in_1_valid));
    vlSelfRef.d_arb__DOT____VdfgRegularize_hbadb2dd2_0_0 
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if (vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
            vlSelfRef.__PVT__task_s3_bits_tag = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_tag;
            vlSelfRef.__PVT__task_s3_bits_needProbeAckData 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_needProbeAckData;
            vlSelfRef.__PVT__task_s3_bits_set = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set;
        }
    }
    if (vlSelfRef.io_status_vec_toD_2_valid) {
        vlSelfRef.io_toSourceD_bits_task_mergeA = vlSelfRef.__PVT__task_s5_bits_mergeA;
    ...
    if (vlSymsp->TOP.reset) {
        ...
        if (vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_opcode 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_opcode;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_param 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_param;
            vlSelfRef.__PVT__task_s3_bits_aMergeTask_sourceId 
                = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_aMergeTask_sourceId;
            vlSelfRef.__PVT__task_s3_bits_param = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_param;
            vlSelfRef.__PVT__task_s3_bits_opcode = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_opcode;
        }
    }
    if (vlSelfRef.__PVT___task_s4_valid_T_1) {
        vlSelfRef.__PVT__data_s4 = ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe_io_releaseBufResp_s3_valid_REG)
                                     ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__releaseBuf_io_resp_data_data)
                                     : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__refillBuf_io_resp_data_data));
    }
    vlSelfRef.__PVT__chnl_fire_s4 = ((IData)(vlSelfRef.__PVT___chnl_fire_s4_T) 
                                     | (IData)(vlSelfRef.__PVT___chnl_fire_s4_T_1));
    vlSelfRef.__PVT__req_drop_s4 = ((~ (IData)(vlSelfRef.__PVT__need_write_releaseBuf_s4)) 
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__2(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__2\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.io_toDS_wdata_s3_data = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)
                                        ? ((IData)(vlSelfRef.__PVT__task_s3_bits_useProbeData)
                                        ...
                                        : (IData)(vlSelfRef.io_nestedwbData_data));
    vlSelfRef.__PVT__c_arb_io_in_2_bits_data_data = 
        ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe_io_releaseBufResp_s3_valid_REG)
          ? (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__releaseBuf_io_resp_data_data)
          : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__refillBuf_io_resp_data_data));
    vlSelfRef.__VdfgRegularize_hb02e9cef_0_7 = (1U 
                                                & (~ 
                                                   ((~ (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_metaWen)) 
                                                    & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_mshrTask))));
    vlSelfRef.io_toSourceC_bits_data_data = ((IData)(vlSelfRef.io_status_vec_toC_2_valid)
                                              ? (IData)(vlSelfRef.__PVT__c_arb_io_in_0_bits_data_data)
                                              : ((IData)(vlSelfRef.__PVT__c_arb_io_in_1_valid)
                                                  ? (IData)(vlSelfRef.__PVT__data_s4)
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__3(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__3\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*2:0*/ __PVT__customL1Hint_io_s3_task_bits_opcode;
    __PVT__customL1Hint_io_s3_task_bits_opcode = 0;
    ...
    // Body
    __PVT__hit_s3 = ((IData)(vlSelfRef.__PVT___io_toMSHRCtl_mshr_alloc_s3_valid_T_1) 
                     & (0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)));
    __PVT__miss_s3 = ((~ (IData)((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)))) 
                      & (IData)(vlSelfRef.__PVT___io_toMSHRCtl_mshr_alloc_s3_valid_T_1));
    __PVT___sink_resp_s3_bits_param_T_6 = (((IData)(vlSelfRef.__PVT__task_s3_bits_param) 
                                            << 2U) 
                                           | (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state));
    __PVT__sink_resp_s3_a_promoteT = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)) 
                                      & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state) 
                                         >> 1U));
    __VdfgRegularize_hb02e9cef_0_5 = (((3U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                       & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_dirty)) 
                                      | (IData)(vlSelfRef.__PVT__task_s3_bits_needProbeAckData));
    if (vlSymsp->TOP.reset) {
        vlSelfRef.__PVT__task_s3_bits_reqSource = 0U;
        vlSelfRef.__PVT__task_s3_bits_sourceId = 0U;
        vlSelfRef.__PVT__task_s3_bits_off = 0U;
        vlSelfRef.__PVT__task_s3_bits_channel = 0U;
    } else if (vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) {
        vlSelfRef.__PVT__task_s3_bits_reqSource = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_reqSource;
        vlSelfRef.__PVT__task_s3_bits_sourceId = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_sourceId;
        vlSelfRef.__PVT__task_s3_bits_off = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_off;
        vlSelfRef.__PVT__task_s3_bits_channel = vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_channel;
    }
    vlSelfRef.__PVT___T_103 = ((IData)(vlSelfRef.__PVT___io_toMSHRCtl_mshr_alloc_s3_valid_T_1) 
                               & (IData)(vlSelfRef.__PVT__task_s3_bits_channel));
    vlSelfRef.__PVT__next_counter_14 = (vlSelfRef.__PVT__counter_14 
    ...
    __PVT___mshr_probeack_s3_T_2 = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask) 
                                    & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                       >> 1U));
    __PVT__need_mshr_s3_b = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)) 
                             & (((~ (((1U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                      | (3U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state))) 
                                     & (1U == (IData)(vlSelfRef.__PVT__task_s3_bits_param)))) 
                                 & ((IData)(vlSelfRef.__PVT__task_s3_bits_channel) 
                                    >> 1U)) & (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_clients)));
    __PVT__sinkA_req_s3 = (1U & ((~ (IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)) 
                                 & (IData)(vlSelfRef.__PVT__task_s3_bits_channel)));
    __PVT___mshr_grant_s3_T_2 = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask) 
                                 & (IData)(vlSelfRef.__PVT__task_s3_bits_channel));
    if ((2U & (IData)(vlSelfRef.__PVT__task_s3_bits_channel))) {
        vlSelfRef.__PVT___GEN_55 = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28))
                                     ? ((3U == (IData)(__PVT___sink_resp_s3_bits_param_T_6))
                                         ? 3U : ((7U 
                                                  == (IData)(__PVT___sink_resp_s3_bits_param_T_6))
                                                  ? 0U
                                                 ...
                                                 ((0xbU 
                                                  ...
                                                  ((9U 
                                                    ...
                                                    : 4U))))
                                     : 5U);
        vlSelfRef.__PVT___GEN_54 = (((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)) 
                                     & (IData)(__VdfgRegularize_hb02e9cef_0_5))
                                     ? 5U : 4U);
    } else {
        vlSelfRef.__PVT___GEN_55 = 0U;
    ...
    __PVT__need_data_b = ((IData)(__PVT__sinkB_req_s3) 
                          & ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)) 
                             & ((2U == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                | (IData)(__VdfgRegularize_hb02e9cef_0_5))));
    vlSelfRef.__PVT__wen_c = ((IData)(__PVT__sinkC_req_s3) 
                              & ((IData)(vlSelfRef.__PVT___wen_c_T_4) 
                                 & ((IData)(vlSelfRef.__PVT__task_s3_bits_opcode) 
    ...
    if (__PVT__req_acquire_s3) {
        ...
        vlSelfRef.io_toMSHRCtl_mshr_alloc_s3_bits_task_aliasTask 
            = ((0U != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)) 
               & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_clients) 
                  & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_alias) 
                     != (IData)(vlSelfRef.__PVT__task_s3_bits_alias))));
    } else {
        vlSelfRef.__PVT___sink_resp_s3_bits_param_T_4 = 0U;
        vlSelfRef.io_toMSHRCtl_mshr_alloc_s3_bits_task_aliasTask = 0U;
    ...
    __PVT__need_mshr_s3_a = ((IData)(__PVT__need_acquire_s3_a) 
                             | (IData)(__PVT___need_write_releaseBuf_T));
    if (__PVT___io_toDS_req_s3_bits_way_T) {
        vlSelfRef.io_tagWReq_bits_way = vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_replResp_bits_way;
        vlSelfRef.io_toDS_req_s3_bits_way = vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_replResp_bits_way;
    } else {
        vlSelfRef.io_tagWReq_bits_way = vlSelfRef.__PVT__task_s3_bits_way;
        vlSelfRef.io_toDS_req_s3_bits_way = ((IData)(vlSelfRef.__PVT__task_s3_bits_mshrTask)
                                              ? (IData)(vlSelfRef.__PVT__task_s3_bits_way)
                                              : (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_way));
    }
    vlSelfRef.__PVT__need_write_releaseBuf = ((IData)(__PVT___need_write_releaseBuf_T) 
                                              | (((IData)(__PVT__need_data_b) 
                                                  & (IData)(__PVT__need_mshr_s3_b)) 
    ...
    vlSelfRef.__PVT___io_metaWReq_valid_T_1 = ((IData)(vlSelfRef.__PVT__metaW_valid_s3_a) 
                                               | ((~ (IData)(__PVT__need_mshr_s3_b)) 
                                                  & ((IData)(__PVT__sinkB_req_s3) 
                                                     & ((0U 
                                                         != (IData)(vlSymsp->TOP.__VdfgRegularize_hd87f99a1_1_28)) 
                                                        & ((3U 
                                                            == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
                                                           | ((1U 
                                                               == (IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__directory_io_resp_bits_meta_state)) 
    ...
    vlSelfRef.__PVT__sourceD_pipe_len = (((IData)(vlSelfRef.io_status_vec_toD_2_valid)
                                         ...
                                         | (((IData)(vlSelfRef.__PVT___chnl_fire_s4_T_1)
                                            ...
                                            | ((IData)(__PVT___chnl_fire_s3_T_1)
                                                ? 3U
                                                : 0U)));
    vlSelfRef.__PVT__sourceC_pipe_len = ((((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sourceC__DOT__queue_io_enq_ready) 
                                           & (IData)(vlSelfRef.io_status_vec_toC_2_valid))
                                           ? 5U : 0U) 
                                         | (((IData)(vlSelfRef.__PVT___chnl_fire_s4_T)
                                              ? 4U : 0U) 
...
VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__4(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__4\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.io_toReqArb_blockG_s1 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                       & ((IData)(vlSelfRef.__VdfgRegularize_hb02e9cef_0_7) 
                                          & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_bits_set) 
                                             == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set))));
    vlSelfRef.io_toReqArb_blockB_s1 = ((((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                       ...
                                       | (((IData)(vlSelfRef.__PVT__task_s4_valid) 
                                          ...
                                          | ((IData)(vlSelfRef.__PVT__task_s5_valid) 
                                             & (((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkB_io_task_bits_set) 
                                                ...
                                                & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkB_io_task_bits_tag) 
                                                   == (IData)(vlSelfRef.__PVT__task_s5_bits_tag))))));
    vlSelfRef.io_toReqArb_blockC_s1 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                                       & ((IData)(vlSelfRef.__VdfgRegularize_hb02e9cef_0_7) 
                                          & ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC.io_task_bits_set) 
                                             == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set))));
    vlSelfRef.io_toReqBuf_0 = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_valid) 
                               & ((IData)(vlSelfRef.__VdfgRegularize_hb02e9cef_0_7) 
                                  & ((IData)(vlSymsp->TOP.VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkA_io_task_bits_set) 
                                     == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__task_s2_bits_set))));
}

VL_INLINE_OPT void VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__5(VVerifyTop_MainPipe_2* vlSelf) {
    (void)vlSelf;  // Prevent unused variable warning
    VVerifyTop__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            VVerifyTop_MainPipe_2___nba_sequent__TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__mainPipe__5\n"); );
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    CData/*0:0*/ __PVT__customL1Hint__DOT__hint_s1Queue_io_enq_valid;
    __PVT__customL1Hint__DOT__hint_s1Queue_io_enq_valid = 0;
    ...
    __PVT__customL1Hint__DOT__mshr_Grant_s1 = 0;
    // Body
    if (vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_mergeA) {
        vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue_io_enq_bits_source 
            = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_valid)
                ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_bits_aMergeTask_sourceId)
                : ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT___sinkValids_T_1)
                    ? 0U : (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT___chnl_task_s1_bits_T_4_aMergeTask_sourceId)));
        __PVT__customL1Hint__DOT___mshr_GrantData_s1_T_7 
            = (1U & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel));
    } else {
        vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue_io_enq_bits_source 
            = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_valid)
                ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT__mshr_task_s1_bits_sourceId)
                : ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT___sinkValids_T_1)
                    ? (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__sinkC.io_task_bits_sourceId)
                    : (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.__PVT___chnl_task_s1_bits_T_4_sourceId)));
        __PVT__customL1Hint__DOT___mshr_GrantData_s1_T_7 = 0U;
    }
    __PVT__customL1Hint__DOT___mshr_GrantData_s1_T 
        = ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_mshrTask) 
           & (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_valid));
    __PVT__customL1Hint__DOT__mshr_GrantData_s1 = ((IData)(__PVT__customL1Hint__DOT___mshr_GrantData_s1_T) 
                                                   & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel) 
                                                       & (5U 
                                                          == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode))) 
                                                      | ((IData)(__PVT__customL1Hint__DOT___mshr_GrantData_s1_T_7) 
                                                         & (5U 
                                                            == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_aMergeTask_opcode)))));
    __PVT__customL1Hint__DOT__mshr_Grant_s1 = ((IData)(__PVT__customL1Hint__DOT___mshr_GrantData_s1_T) 
                                               & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel) 
                                                   & (4U 
                                                      == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode))) 
        ...
        = ((IData)(__PVT__customL1Hint__DOT__mshr_GrantData_s1) 
           | ((IData)(__PVT__customL1Hint__DOT__mshr_Grant_s1) 
              | ((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_valid) 
                 & ((~ (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_taskInfo_s1_bits_mshrTask)) 
                    & (((IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_channel) 
                        >> 2U) & ((6U == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode)) 
                                  | (7U == (IData)(vlSymsp->TOP__VerifyTop__DOT__coupledL2_1__DOT__slices_0__DOT__reqArb.io_dirRead_s1_bits_replacerInfo_opcode))))))));
    vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue__DOT___do_enq_T 
        = ((~ ((IData)(vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue__DOT__ptr_match) 
               & (IData)(vlSelfRef.__PVT__customL1Hint__DOT__hint_s1Queue__DOT__maybe_full))) 
           & (IData)(__PVT__customL1Hint__DOT__hint_s1Queue_io_enq_valid));
